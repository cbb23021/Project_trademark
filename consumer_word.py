...
from conn_mongodb import status_open,status_doing,status_done_word
...
def getdata():
    ...
    props = {
        ...
        'group.id': 'word',  # ConsumerGroup的名稱 (置換成你/妳的學員ID)
        ...
        while True:
            ...
            for record in records:
                ...
                if record.error():
                    ...
                    #mongodb-done
                    status_done_word(msgValue, name1, name2, name3, name4, name5,
                    ...
                    print("Model_word Success")
                    # 步驟6.關掉Consumer實例的連線
                    consumer.commit(asynchronous=False)
                    consumer.close()
                    return print("consumer_word done!!!")
