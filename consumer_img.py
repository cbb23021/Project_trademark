...
from conn_mongodb import status_open,status_doing,status_done_img
...
def getdata():
    ...
    props = {
        ...
        'group.id': 'img',  # ConsumerGroup的名稱 (置換成你/妳的學員ID)
        ...
        while True:
            ...
            for record in records:
                ...
                if record.error():
                    ...
                    print("Model_img Success")
                    # 步驟6.關掉Consumer實例的連線
                    consumer.commit(asynchronous=False)
                    consumer.close()
                    return print("consumer_img done!!!")
